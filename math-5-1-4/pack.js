const PROBLEM_PACK = {
  ...
  problems: [
    ...
    // 이지: 크기 비교 (분모 같거나 단순)
    { difficulty: 'easy', topic: '크기비교', hint: '분모가 같으면 분자가 클수록 큰 분수예요.', text: '3/7과 5/7 중 더 큰 것은?', answer: '5/7' },
    { difficulty: 'easy', topic: '크기비교', hint: '분모가 같으면 분자가 클수록 커요.', text: '2/9과 7/9 중 더 큰 것은?', answer: '7/9' },
    { difficulty: 'easy', topic: '크기비교', hint: '분자가 같으면 분모가 작을수록 큰 분수예요.', text: '1/3과 1/5 중 더 큰 것은?', answer: '1/3' },
    { difficulty: 'easy', topic: '크기비교', hint: '분자가 같을 때 분모가 작을수록 커요.', text: '1/2과 1/4 중 더 큰 것은?', answer: '1/2' },
    ...
    { difficulty: 'easy', topic: '분수↔소수', hint: '0.5 = 5/10 = 1/2예요.', text: '0.5와 1/2 중 더 큰 것은?', answer: '같다' },
    { difficulty: 'easy', topic: '분수↔소수', hint: '1/2 = 0.5예요. 0.3과 비교해보세요.', text: '1/2과 0.3 중 더 큰 것은?', answer: '1/2' },
    ...
    // 노멀: 크기 비교
    { difficulty: 'normal', topic: '크기비교', hint: '통분해서 비교해요. 공통분모는 4예요.', text: '1/2과 3/4 중 더 큰 것은?', answer: '3/4' },
    { difficulty: 'normal', topic: '크기비교', hint: '공통분모 6으로 통분해보세요. 1/2=3/6, 1/3=2/6.', text: '1/2과 1/3 중 더 큰 것은?', answer: '1/2' },
    { difficulty: 'normal', topic: '크기비교', hint: '공통분모 15: 2/3=10/15, 3/5=9/15.', text: '2/3과 3/5 중 더 큰 것은?', answer: '2/3' },
    { difficulty: 'normal', topic: '크기비교', hint: '공통분모 12: 3/4=9/12, 2/3=8/12.', text: '3/4과 2/3 중 더 큰 것은?', answer: '3/4' },
    { difficulty: 'normal', topic: '크기비교', hint: '공통분모 8: 1/2=4/8, 3/8은 그대로.', text: '1/2과 3/8 중 더 큰 것은?', answer: '1/2' },
    { difficulty: 'normal', topic: '크기비교', hint: '공통분모 10: 4/5=8/10, 7/10은 그대로.', text: '4/5과 7/10 중 더 큰 것은?', answer: '4/5' },
    { difficulty: 'normal', topic: '크기비교', hint: '공통분모 12: 5/6=10/12, 7/12는 그대로.', text: '5/6과 7/12 중 더 큰 것은?', answer: '5/6' },
    { difficulty: 'normal', topic: '크기비교', hint: '공통분모 12: 2/3=8/12, 3/4=9/12.', text: '2/3과 3/4 중 더 큰 것은?', answer: '3/4' },
    ...
    { difficulty: 'normal', topic: '분수↔소수', hint: '3/5 = 0.6이에요. 0.6과 비교해보세요.', text: '3/5과 0.6 중 더 큰 것은?', answer: '같다' },
    { difficulty: 'normal', topic: '분수↔소수', hint: '3/4 = 0.75예요. 0.8과 비교해보세요.', text: '3/4과 0.8 중 더 큰 것은?', answer: '0.8' },
    { difficulty: 'normal', topic: '분수↔소수', hint: '4/5 = 0.8이에요. 0.75와 비교해보세요.', text: '4/5과 0.75 중 더 큰 것은?', answer: '4/5' },
    { difficulty: 'normal', topic: '분수↔소수', hint: '1/2 = 0.5예요. 0.4와 비교해보세요.', text: '1/2과 0.4 중 더 큰 것은?', answer: '1/2' },
    ...
    // 하드: 통분 (큰 수 최소공배수)
    { difficulty: 'hard', topic: '통분', hint: '4와 6의 최소공배수: 4=2², 6=2×3이므로 2²×3=12예요.', text: '3/4와 5/6의 공통분모(최소)는?', answer: '12' },
    { difficulty: 'hard', topic: '통분', hint: '6과 9의 최소공배수: 6=2×3, 9=3²이므로 2×3²=18이에요.', text: '5/6와 7/9의 공통분모(최소)는?', answer: '18' },
    { difficulty: 'hard', topic: '통분', hint: '8과 12의 최소공배수: 8=2³, 12=2²×3이므로 2³×3=24예요.', text: '5/8와 7/12의 공통분모(최소)는?', answer: '24' },
    { difficulty: 'hard', topic: '통분', hint: '9와 15의 최소공배수: 9=3², 15=3×5이므로 3²×5=45예요.', text: '4/9와 7/15의 공통분모(최소)는?', answer: '45' },
    { difficulty: 'hard', topic: '통분', hint: '10과 15의 최소공배수: 10=2×5, 15=3×5이므로 2×3×5=30이에요.', text: '3/10와 4/15의 공통분모(최소)는?', answer: '30' },

    // 하드: 크기 비교 (세 분수 비교)
    { difficulty: 'hard', topic: '크기비교', hint: '공통분모 12로 통분: 2/3=8/12, 3/4=9/12, 7/12는 그대로.', text: '2/3, 3/4, 7/12 중 가장 큰 것은?', answer: '3/4' },
    { difficulty: 'hard', topic: '크기비교', hint: '공통분모 30: 3/5=18/30, 2/3=20/30, 7/10=21/30.', text: '3/5, 2/3, 7/10 중 가장 큰 것은?', answer: '7/10' },
    { difficulty: 'hard', topic: '크기비교', hint: '공통분모 24: 5/8=15/24, 7/12=14/24, 3/4=18/24.', text: '5/8, 7/12, 3/4 중 가장 큰 것은?', answer: '3/4' },
    { difficulty: 'hard', topic: '크기비교', hint: '공통분모 20: 3/4=15/20, 4/5=16/20, 7/10=14/20.', text: '3/4, 4/5, 7/10 중 가장 큰 것은?', answer: '4/5' },
    { difficulty: 'hard', topic: '크기비교', hint: '공통분모 18: 5/6=15/18, 7/9=14/18, 5/6이 더 크네요.', text: '5/6과 7/9 중 더 큰 것은?', answer: '5/6' },

    // 하드: 분수↔소수 (복잡한 변환 + 세 수 비교)
    { difficulty: 'hard', topic: '분수↔소수', hint: '2/5 = 0.4, 3/8 = 0.375예요. 비교해보세요.', text: '2/5과 3/8 중 더 큰 것은?', answer: '2/5' },
    { difficulty: 'hard', topic: '분수↔소수', hint: '7/8 = 0.875예요. 0.9와 비교해보세요.', text: '7/8과 0.9 중 더 큰 것은?', answer: '0.9' },
    { difficulty: 'hard', topic: '분수↔소수', hint: '5/8 = 0.625예요. 0.63과 비교해보세요.', text: '5/8과 0.63 중 더 큰 것은?', answer: '0.63' },
    ...
    { difficulty: 'hard', topic: '분수↔소수', hint: '3/4=0.75, 0.7, 5/8=0.625. 순서대로 비교해보세요.', text: '3/4, 0.7, 5/8 중 가장 큰 것은?', answer: '3/4' },
    { difficulty: 'hard', topic: '분수↔소수', hint: '2/3≈0.667, 0.65, 3/5=0.6. 비교해보세요.', text: '2/3, 0.65, 3/5 중 가장 큰 것은?', answer: '2/3' },
  ]
};
